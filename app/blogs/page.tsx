    ...
    return (
        <div className="flex flex-col gap-4 container mx-auto p-4">
            ...
            <ul className="mt-4 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {blogs.map((blog) =>
                    <li
                        className="border border-gray-300 p-4 rounded-md shadow-md flex flex-col gap-2 hover:shadow-gray-400 hover:scale-101 transition-shadow duration-300 ease-in-out"
                        key={blog.id}>
